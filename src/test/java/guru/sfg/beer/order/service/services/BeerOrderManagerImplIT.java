...
import guru.sfg.beer.order.service.BeerOrderManager;
...
public class BeerOrderManagerImplIT {
    ...
    void testAllocationFailure() throws JsonProcessingException {
        ...
        var allocationFailureEvent = (AllocationFailureEvent) jmsTemplate.receiveAndConvert(JmsConfig.ALLOCATE_FAILURE_QUEUE);
    ...
    void testAllocatedToCancel() throws JsonProcessingException {
        ...
        var deallocateOrderRequest = (DeallocateOrderRequest) jmsTemplate.receiveAndConvert(JmsConfig.DEALLOCATE_ORDER_QUEUE);
    ...
    public BeerOrder createBeerOrder() {
        ...
        var lines = new HashSet<BeerOrderLine>();
